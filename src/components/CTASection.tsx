...
export const CTASection = ({ onOpenAuth }: CTASectionProps) => {
  return (
    <section className="py-20 bg-gradient-to-br from-christian-navy to-gray-800 text-white relative overflow-hidden">
      {/* Background Pattern */}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center">
              <div className="bg-christian-blue/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Heart className="h-8 w-8 text-christian-gold" />
              </div>
            ...
            <div className="text-center">
              <div className="bg-christian-blue/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Users className="h-8 w-8 text-christian-gold" />
              </div>
            ...
            <div className="text-center">
              <div className="bg-christian-blue/20 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                <Calendar className="h-8 w-8 text-christian-gold" />
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              className="btn-gold text-lg px-10 py-4 font-semibold"
            >
              Join Free Today
            </Button>
            <Button 
              ...
              className="text-lg px-10 py-4 border-white text-white hover:bg-white hover:text-christian-navy transition-all duration-300"
            >
              Sign In
            </Button>
          </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-700">
            <p className="text-lg font-playfair italic text-christian-gold mb-2">
